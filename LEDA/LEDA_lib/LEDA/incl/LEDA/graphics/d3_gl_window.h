...
#define LEDA_ROOT_INCL_ID 440270
...
/*{\Mcreation W}*/
 ...
 d3_gl_window(window& P, const gl_camera& gl_cam,
	 const set<d3_gl_scene*>& S = set<d3_gl_scene*>());
 /*{\Mcreate
 ...
 d3_gl_window(const gl_window& glW, const gl_camera& gl_cam,
			  window* M = NULL, const set<d3_gl_scene*>& S = set<d3_gl_scene*>());
 /*{\Mcreate
